...
target.classList.add('active');
	...
	_finish: function () {
		...
		Array.prototype.forEach.call(this._resto, (resto) => {
			...
			html += "	<span class='result-adresse' data-value='" + escape(resto.adresse) + "'>" + resto.adresse + "</span><br><br>";
			html += "	<span class='result-code_postal' data-value='" + escape(resto.code_postal) + "'>" + resto.code_postal + "</span><br><br>";
