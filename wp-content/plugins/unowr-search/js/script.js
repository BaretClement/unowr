var unowr_form = {
	...
	_finish: function () {
		...
		Array.prototype.forEach.call(this._resto, (resto) => {
			...
			html += "	<div class='chip'><p class='result-subcategory' data-value='" + resto.category + ", " + resto.subcategory + ", " + resto.category + "</div>, <div class='chip'>" + resto.subcategory + "</div></span><br>";
