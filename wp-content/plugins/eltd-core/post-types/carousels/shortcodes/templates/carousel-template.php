<div class="eltd-carousel-item-holder">
	<?php if ($link !== '') { ?>
	...
	<?php } ?>
		...
		<?php } ?>
		<?php if ($hover_image !== '') { ?>
			<span class="eltd-carousel-second-image-holder <?php echo esc_attr($hover_class); ?> <?php echo esc_attr($carousel_image_classes); ?>">
