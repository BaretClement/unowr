...
class ElatedInstagramWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Display instagram images', 'eltd' ) )
		);
	...
	public function widget($args, $instance) {
		...
		$user_id = '';
		if ( $username !== '' ) {
			$user_id = $instagram_api->getUserIDFromUsername( $username );
		}
		$images_array = $instagram_api->getImages($number_of_photos, $tag, $user_id, array(
			'use_transients' => true,
