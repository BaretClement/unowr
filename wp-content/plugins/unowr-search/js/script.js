var unowr_form = {
	...
	_finish: function () {
		...
		Array.prototype.forEach.call(this._resto, (resto) => {
			...
			html += "	<p class='result-id question search' data-value='" + resto.id + "' style='font-family: 'Coves Bold';'></p>";
			...
			html += "	<span class='result-subcategory' data-value='" + resto.category + ", " + resto.subcategory + ", " + resto.category + ", " + resto.subcategory + "</span><br>";
