<?php
namespace ElatedListing\CPT;

use ElatedListing\Lib;

/**
 * Class PostTypesLoader
 * @package ElatedListing\CPT
 */
class PostTypesRegister {
    ...
    private function addPostTypes() {
		$this->addPostType(new Listing\ListingRegister());
		$this->addPostType(new ListingType\ListingTypeRegister());
		$this->addPostType(new ListingPackage\ListingPackageRegister());
    }
